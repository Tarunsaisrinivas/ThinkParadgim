    ...
    >
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8 text-lg">
          ...
          <a href="#aboutus" className={`hover:text-blue-300 ${scroll ? 'text-blue-900' : 'text-white'}`}>About Us</a>
          <a href="#services" className={`hover:text-blue-300 ${scroll ? 'text-blue-900' : 'text-white'}`}>Services</a>
          <a href="#contactForm" className={`hover:text-blue-300 ${scroll ? 'text-blue-900' : 'text-white'}`}>Contact Us</a>
      ...
      >
        ...
        <a href="#aboutus" className="block px-4 py-2 text-sm">About Us</a>
        <a href="#services" className="block px-4 py-2 text-sm">Services</a>
        <a href="#contactForm" className="block px-4 py-2 text-sm">Contact Us</a>
